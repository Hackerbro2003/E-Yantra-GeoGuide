...
# Team ID:			[  eYRC#GG#3902 ]
# Author List:		[ Kiran , Dheenadhayalan , Elango , Suriyashakthi ]
# Filename:			task_2a.py
    ...
    * ArUco_corners = 
    ...
    if ids is not None:
        for i in range(len(ids)):
            ...
            angle = int(math.degrees(math.atan2(corner_coordinates[1][1] - corner_coordinates[0][1],corner_coordinates[1][0] - corner_coordinates[0][0])))
...
if __name__ == "__main__":
    ...
    img_dir_path = "D:\Task_2A_files\public_test_cases\\"
